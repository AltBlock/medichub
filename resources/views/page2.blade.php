    ...
    <div class="container">
        <div class="row centered">
            ...
            <div class="col-sm-8 col-sm-offset-2">
                {!! Form::open(['action' => 'LA\PredictsController@disease', 'id' => 'symptom-add-form']) !!}
                    <?php 
                    	//dd($questionare);
                    	foreach ($questionare as $qset) {
                    		$flag = 1;
                    		...
                    		?>
                    			<div class="single-block">
		                    		...
		                    		foreach ($qset as $qs) {
		                    			//dd($qs);
			                    		?>
			                    			<input type="checkbox" name="mhistory[]" id="{{ $flag }}" value="{{ $qs->id }}">
			                    			<label for="{{ $flag }}">{{ $qs->name }}</label><br>
			                    		<?php
			                    		$flag++;
		                    		}
		                    		?>
