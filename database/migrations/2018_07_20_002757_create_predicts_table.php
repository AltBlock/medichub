...
class CreatePredictsTable extends Migration
{
    ...
    public function up()
    {
        Module::generate("Predicts", 'predicts', 'symptom', 'fa-cube', [
            ["symptom", "Symptom", "Multiselect", false, "", 0, 0, false, "@symptoms"],
            ["history", "History", "Multiselect", false, "", 0, 0, false, "@histories"],
        ]);
